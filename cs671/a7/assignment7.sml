...
local
     ...
     val S = emptySet NONE
     val F = emptySet NONE
     val F = addList(F,listOne)
     val S = addList(S,listTwo) (* they are not disjoint *)
     val F = insert(41,F);
...
fun run() = apply [test01,test02,testf,tester1,testvmf,AuBnA,myftest,test08,test06,FTest,testzt (*, ... more tests here *)]
...
(* Apply a selection of tests *)
fun run() = apply [test01,test02,testnf,tester2,testvmnf,AisSubA',distTest,mynftest,test08,test02,testzt]
